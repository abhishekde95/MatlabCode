...
[filelist,filelistpath] = uigetfile('*.txt', ...
...
if isequal(filelist,0)
    ...
    gl.prev_path = fullfile(filelistpath, filelist);
    fnames = flatten(fnamesFromTxt2(gl.prev_path));
...
if isempty(gl.incoming_fnames) % in case the text file was empty
    gl.init_new_exp = true;
end
