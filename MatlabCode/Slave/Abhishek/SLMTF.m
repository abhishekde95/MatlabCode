...
global gl
SUBJECT_IDX = ''; % 1: Greg, 2: Abhishek, 3: Emily
STIM_DURATION = 1000; % ms
STIM_POSITION = 0; % tenths of degrees
FPSIZE = 1 ; % tenths of degrees
NCONTRASTS = 50;
TIME_POSITION = [1 2];
...
while true
    ...
    if gl.stim.on
        if gl.stim.needs_update
            ...
            sf_idx = ceil(gl.stim.next_2_be_shown_idx(end)/numel(gl.stim.sf));
