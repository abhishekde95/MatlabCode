...
if ismac
    save('/Users/jpatrickweller/Dropbox/VisionResearchPaper/Fig2aData(RS)','data');
else ispc
    save('C:\Users\jpweller\Dropbox\VisionResearchPaper\Fig2aData(RS)','data');
end

% Say goodbye
disp('Fig 2a Modeling Completed.')
