% This code fits curves to psych and chron data for two k's, one A, one Tnd, and no B,
% for H and L coherences

function [th_fit1,err1] = fitwithcurves1(df,tg)
...
[th_fit1,err1]=fminsearch('calcparams1',tg(1:4),opts,df);
...
p_pred_chron2H=A./(kH.*xax).*tanh(kH.*A.*xax)+Tnd;
p_pred_chron2L=A./(kL.*xax).*tanh(kL.*A.*xax)+Tnd;
...
title('Psychometric Fit to High and Low Coherences (Different ks, No B)')
...
title('Chronometric Fit to High and Low Coherences (Different ks, No B)')
