function out = getWhtnsStats(stro,nframesback,module, initargs, spikename, M, allstim)
...
nstixperside = stro.sum.exptParams.nstixperside; %get number of stixels per side
