% Creating figures for Thesis Committee Meeting 4, 
% Code derived from Greg's Janelia color vision talk
...
figure(plot_counter); set(gcf,'Name','DO along with Crescent fits');
count = 1;
...
% plotting crescent fits of DO cells
...
% Figure 2: plotting the R2(Gabor) vs R2 (DOG). Simple cells in one color, DO cells(L-M and S-dominated) in another
...
for ii = 1:length(fnames)
    if any(ismember(LumIds_conewts,ii))
        h(ii) = plot(meanR(ii,2), meanR(ii,3),'o','MarkerFaceColor',[0 1 0],'MarkerEdgeColor',[1 1 1]);
        set(h(ii),'ButtonDownFcn',['disp(''', char(fnames{ii,:}),''')']);
    elseif any(ismember(ColorOpponentIds_conewts,ii))
        h(ii) = plot(meanR(ii,2), meanR(ii,3),'o','MarkerFaceColor',[1 0.5 0],'MarkerEdgeColor',[1 1 1]);
        set(h(ii),'ButtonDownFcn',['disp(''', char(fnames{ii,:}),''')']);
...
plot([0 1],[0 1],'k');
xlabel('Gabor R2'); ylabel('non-concentric DOG R2'); set(gca,'TickDir','out','Ylim',[0 1],'Xlim',[0 1],'XTick',0:0.5:1.0,'YTick',0:0.5:1); axis square; hold off;
subplot(122); hold on;
for ii = 1:length(fnames)
    if any(ismember(LumIds_conewts,ii))
        h(ii) = plot(meanR(ii,2), meanR(ii,1),'o','MarkerFaceColor',[0 1 0],'MarkerEdgeColor',[1 1 1]);
        set(h(ii),'ButtonDownFcn',['disp(''', char(fnames{ii,:}),''')']);
    elseif any(ismember(ColorOpponentIds_conewts,ii))
        h(ii) = plot(meanR(ii,2), meanR(ii,1),'o','MarkerFaceColor',[1 0.5 0],'MarkerEdgeColor',[1 1 1]);
        set(h(ii),'ButtonDownFcn',['disp(''', char(fnames{ii,:}),''')']);
    elseif any(ismember(Sconedominated_conewts,ii))
        h(ii) = plot(meanR(ii,2), meanR(ii,1),'o','MarkerFaceColor',[1 0.5 0],'MarkerEdgeColor',[1 1 1]);
        set(h(ii),'ButtonDownFcn',['disp(''', char(fnames{ii,:}),''')']);
...
plot([0 1],[0 1],'k');
xlabel('Gabor R2'); ylabel('non-concentric DOG R2'); set(gca,'TickDir','out','Ylim',[0 1],'Xlim',[0 1],'XTick',0:0.5:1.0,'YTick',0:0.5:1.0); axis square; hold off;
plot_counter = plot_counter + 1;

figure(plot_counter); set(gcf,'Name','Gabor vs DoG');
subplot(131); hold on;
for ii = 1:length(fnames)
    if any(ismember(LumIds_conewts,ii))
        h(ii) = plot(meanSSE(ii,2), meanSSE(ii,3),'o','MarkerFaceColor',[0 1 0],'MarkerEdgeColor',[1 1 1]);
        set(h(ii),'ButtonDownFcn',['disp(''', char(fnames{ii,:}),''')']);
    elseif any(ismember(ColorOpponentIds_conewts,ii))
        h(ii) = plot(meanSSE(ii,2), meanSSE(ii,3),'o','MarkerFaceColor',[1 0.5 0],'MarkerEdgeColor',[1 1 1]);
        set(h(ii),'ButtonDownFcn',['disp(''', char(fnames{ii,:}),''')']);
    elseif any(ismember(Sconedominated_conewts,ii))
        h(ii) = plot(meanSSE(ii,2), meanSSE(ii,3),'o','MarkerFaceColor',[1 0.5 0],'MarkerEdgeColor',[1 1 1]);
        set(h(ii),'ButtonDownFcn',['disp(''', char(fnames{ii,:}),''')']);
...
plot([0 2],[0 2],'k');
xlabel('Gabor SSE'); ylabel('DOG SSE'); set(gca,'TickDir','out','Ylim',[0 2],'Xlim',[0 2],'XTick',0:1:2.0,'YTick',0:1:2.0); axis square; hold off;
subplot(132); hold on;
for ii = 1:length(fnames)
    if any(ismember(LumIds_conewts,ii))
        h(ii) = plot(meanperaccuracy(ii,2), meanperaccuracy(ii,3),'o','MarkerFaceColor',[0 1 0],'MarkerEdgeColor',[1 1 1]);
        set(h(ii),'ButtonDownFcn',['disp(''', char(fnames{ii,:}),''')']);
    elseif any(ismember(ColorOpponentIds_conewts,ii))
        h(ii) = plot(meanperaccuracy(ii,2), meanperaccuracy(ii,3),'o','MarkerFaceColor',[1 0.5 0],'MarkerEdgeColor',[1 1 1]);
        set(h(ii),'ButtonDownFcn',['disp(''', char(fnames{ii,:}),''')']);
    elseif any(ismember(Sconedominated_conewts,ii))
        h(ii) = plot(meanperaccuracy(ii,2), meanperaccuracy(ii,3),'o','MarkerFaceColor',[1 0.5 0],'MarkerEdgeColor',[1 1 1]);
        set(h(ii),'ButtonDownFcn',['disp(''', char(fnames{ii,:}),''')']);
...
plot([0.5 0.9],[0.5 0.9],'k');
xlabel('Gabor ROC'); ylabel('DOG ROC'); set(gca,'TickDir','out','Ylim',[0.5 0.9],'Xlim',[0.5 0.9],'XTick',0.5:0.2:0.9,'YTick',0.5:0.2:0.9); axis square; hold off;
subplot(133); hold on;
for ii = 1:length(fnames)
    if any(ismember(LumIds_conewts,ii))
        h(ii) = plot(BICs(ii,2), BICs(ii,3),'o','MarkerFaceColor',[0 1 0],'MarkerEdgeColor',[1 1 1]);
        set(h(ii),'ButtonDownFcn',['disp(''', char(fnames{ii,:}),''')']);
    elseif any(ismember(ColorOpponentIds_conewts,ii))
        h(ii) = plot(BICs(ii,2), BICs(ii,3),'o','MarkerFaceColor',[1 0.5 0],'MarkerEdgeColor',[1 1 1]);
        set(h(ii),'ButtonDownFcn',['disp(''', char(fnames{ii,:}),''')']);
    elseif any(ismember(Sconedominated_conewts,ii))
        h(ii) = plot(BICs(ii,2),BICs(ii,3),'o','MarkerFaceColor',[1 0.5 0],'MarkerEdgeColor',[1 1 1]);
        set(h(ii),'ButtonDownFcn',['disp(''', char(fnames{ii,:}),''')']);
...
plot([-1300 -500],[-1300 -500],'k');
xlabel('Gabor BIC'); ylabel('DOG BIC'); set(gca,'TickDir','out','Ylim',[-1300 -500],'Xlim',[-1300 -500],'XTick',-1300:400:-500,'YTick',-1300:400:-500); axis square; hold off;
...
load newSOidx.mat
load newhardtoclassifyidx.mat
othersidx = [newhardtoclassifyidx newSOidx];
...
histogram(Q_rob(newLUMidx),bins,'Normalization','probability','FaceColor',[0.5 0.5 0.5],'EdgeColor',[1 1 1]); hold on;
histogram(Q_rob(DOidx),bins,'Normalization','probability','FaceColor',[1 0 0],'EdgeColor',[1 1 1]); 
histogram(Q_rob(othersidx),bins,'Normalization','probability','FaceColor',[0 1 0],'EdgeColor',[1 1 1]); 
...
plot(median(Q_rob(othersidx)),0,'kv','MarkerSize',8,'MarkerFaceColor',[0 1 0],'MarkerEdgeColor',[1 1 1]);
axis square; set(gca,'Tickdir','out','Ylim',[0 0.6],'YTick',[0:0.3:0.6]); xlabel('Q'); legend('Lum','DO','htc'); ylabel('Proportion of cells'); 
set(gcf,'renderer','painters');
plot_counter = plot_counter + 1;

%% Plotting control figures 
load newOCidx.mat
load newLMidx.mat
load newLUMidx.mat
load newSOidx.mat
...
absS = (abs(S1LMS(3,:)) + abs(S2LMS(3,:)))/2;
...
[r2,p2] = corr(anglebwvectorsRGB,Q_rob,'Type','Spearman');
[r3,p3] = corr(absS',Q_rob,'Type','Spearman');
x = [ones(numel([OCidx LMidx]),1); 2*ones(numel([LUMidx]),1); 3*ones(numel([SOidx hardtoclassifyidx]),1)]'; 
g = absS([OCidx LMidx LUMidx SOidx hardtoclassifyidx]); p4 = anova1(g,x,'off');
figure(plot_counter); 
subplot(221); plot(anglediffWNchecksubunit(ind_rob),'o','MarkerFacecolor',[0 0 0],'MarkerEdgecolor',[1 1 1]); hold on; lsline; xlabel('Q rob ascending order'); 
ylabel('angle diff check sub'); title(strcat(num2str(r1,2),',',' ',num2str(p1,2))); set(gca,'Tickdir','out','Ylim',[0 120],'YTick',0:60:120); axis square; hold off;
subplot(222); plot(anglebwvectorsRGB(ind_rob),'o','MarkerFacecolor',[0 0 0],'MarkerEdgecolor',[1 1 1]);  hold on; lsline; xlabel('Q rob ascending order'); 
ylabel('angle diff WN sub'); title(strcat(num2str(r2,2),',',' ',num2str(p2,2)));  set(gca,'Tickdir','out','Ylim',[0 180],'YTick',0:60:180); axis square; hold off;
subplot(223); plot(absS(ind_rob),'o','MarkerFacecolor',[0 0 0],'MarkerEdgecolor',[1 1 1]); hold on; lsline; xlabel('Q rob ascending order'); 
ylabel('S'); title(strcat(num2str(r3,2),',',' ',num2str(p3,2))); set(gca,'Tickdir','out','Ylim',[0 0.6],'YTick',0:0.3:0.6); axis square; hold off;
subplot(224); boxplot(g,x,'Notch','on','Labels',{'DO','LUM','Others'}); set(gca,'Tickdir','out','Ylim',[0 0.6],'YTick',0:0.3:0.6); 
title(strcat('abs S',{' '},num2str(p4,3))); axis square; ylabel('S');
plot_counter = plot_counter + 1;

% Plotting if there is any difference in spatial linearity index for CS and Adjacent selected subunits 
load RFstructure_c.mat
load RFstructure_l.mat
RFstructure = [RFstructure_c; RFstructure_l];
Q_rob(Q_rob>max(bins)) = max(bins);
figure(plot_counter); 
histogram(Q_rob(RFstructure==1),bins); hold on; histogram(Q_rob(RFstructure==2),bins); 
plot(median(Q_rob(RFstructure==1)),0,'kv','Markerfacecolor',[0 0 1]); plot(median(Q_rob(RFstructure==2)),0,'kv','Markerfacecolor',[1 0 0]); 
xlabel('Q_rob'); ylabel('# cells'); legend('CS','Adj'); set(gca,'Tickdir','out','YTick',0:10:20,'XTick',0:5:10); axis square;
set(gcf,'renderer','painters');
plot_counter = plot_counter + 1;
%% Trying to simulate some munsell chips 
...
munsellsurfs = randi(totmunsells,N,1);

% Condition 1: Same illuminant but different reflectance spectras
LMSexc1 = []; LMScc1 = [];
for ii = 1:N
    surf = munsell(munsellsurfs(ii),:); % reflectance spectra of surface 1
    lightfromsurf = illuminants(1,:).*surf;
    mean_cone_exc = mean(fundamentals'*(dayBasis(:,1).*surf)',2);
    % LMS calculations
    LMSexc1 = [LMSexc1 fundamentals'*lightfromsurf'];
    LMScc1 = [LMScc1 fundamentals'*lightfromsurf'./mean_cone_exc];
end

% Condition 2: Different scales of illuminant but same reflectance spectras
LMSexc2 = []; LMScc2 = []; fact = rand(N,1);
for ii = 1:N
    surf = munsell(munsellsurfs(1),:); % reflectance spectra of surface 1
    lightfromsurf = fact(ii)*illuminants(1,:).*surf;
    mean_cone_exc = mean(fundamentals'*(dayBasis(:,1).*surf)',2);
    % LMS calculations
    LMSexc2 = [LMSexc2 fundamentals'*lightfromsurf'];
    LMScc2 = [LMScc2 fundamentals'*lightfromsurf'./mean_cone_exc];
end

figure(plot_counter); subplot(221); plot(LMScc1(1,:)+LMScc1(2,:),'k','Linewidth',2); hold on;
plot(LMScc1(1,:)-LMScc1(2,:),'r','Linewidth',2); xlabel('Munsell chips'); ylabel('CC'); set(gca,'Tickdir','out'); title('Condition 1'); axis square; hold off;
subplot(222); plot(LMScc2(1,:)+LMScc2(2,:),'k','Linewidth',2); hold on;
plot(LMScc2(1,:)-LMScc2(2,:),'r','Linewidth',2); xlabel('Munsell chips'); ylabel('CC'); set(gca,'Tickdir','out'); title('Condition 2'); axis square; hold off;
subplot(223); plot(LMSexc1(1,:)+LMSexc1(2,:),'k','Linewidth',2); hold on;
plot(LMSexc1(1,:)-LMSexc1(2,:),'r','Linewidth',2); xlabel('Munsell chips'); ylabel('Exc'); set(gca,'Tickdir','out'); title('Condition 1'); axis square; hold off;
subplot(224); plot(LMSexc2(1,:)+LMSexc2(2,:),'k','Linewidth',2); hold on;
plot(LMSexc2(1,:)-LMSexc2(2,:),'r','Linewidth',2); xlabel('Munsell chips'); ylabel('Exc'); set(gca,'Tickdir','out'); title('Condition 2'); axis square; hold off;