...
filename = [filenamebeh];
RWmultiplier = [RWmultiplierbeh];
laserdial = [laserdialbeh];
...
plot(normcdf(xvals,mu,sigma),normcdf(xvals,0,1),'b','Linewidth',2);
line([0 1],[0 1],'Linewidth',2);axis square; xlabel('FA L'); ylabel('FA NL'); set(gca,'Xlim',[0 1],'Ylim',[0 1],'XTick',0:0.25:1.0,'YTick',0:0.25:1.0,'Tickdir','out');
