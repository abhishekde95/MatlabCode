function [spd,S] = MeasMonSpd(window, settings, S, syncMode, whichMeterType, clutOrRect)
% [spd,S] = MeasMonSpd(window, settings, [S], [syncMode], [whichMeterType], [clutOrRect])
%
...
spd = zeros(S(3), nMeas);
for i = 1:nMeas
    % Set the color of the square and measure its spectrum
