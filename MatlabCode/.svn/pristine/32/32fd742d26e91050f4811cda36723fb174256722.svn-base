...
%      Created with code snippet below. Inspired by an old Matlab FEX
%      function by Steve Eddins. Cannot find it any more on FEX.
%      radius = 50;  % chroma
...
%      % (needs colorspace from Matlab File Exchange)
%
