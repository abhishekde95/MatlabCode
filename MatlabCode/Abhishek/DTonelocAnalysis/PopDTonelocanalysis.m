...
% files from APOLLO
filename14 = {'A011719009.nex';'A011719010.nex';'A011719011.nex';'A011719012.nex'};
RWmultiplier14 = [1.0;1.0;1.0;1.0];
filename15 = {'A012219006.nex';'A012219009.nex';'A012219010.nex';'A012219011.nex';'A012219012.nex';'A012219013.nex'};
RWmultiplier15 = [1.0;0.8;0.8;0.8;0.8;0.8;];
filename16 = {'A012319004.nex';'A012319005.nex';'A012319006.nex';'A012319007.nex';'A012319008.nex';'A012319009.nex';'A012319010.nex';'A012319011.nex'};
RWmultiplier16 = [1.0;1.0;1.0;0.7;0.7;0.7;0.7;0.7];
filename17 = {'A013019003.nex';'A013019004.nex';'A013019005.nex';'A013019006.nex';'A013019007.nex';'A013019008.nex';'A013019009.nex';'A013019012.nex'};
RWmultiplier17 = [1.0;0.7;0.7;0.7;0.7;0.5;0.5;0.7];
filename18 = {'A013119001.nex';'A013119002.nex';'A013119003.nex';'A013119004.nex';'A013119005.nex';'A013119006.nex'};
RWmultiplier18 = [0.7;0.7;0.7;0.7;0.6;0.6];
filename19 = {'A020119001.nex';'A020119002.nex';'A020119003.nex';'A020119004.nex';'A020119005.nex';'A020119006.nex';'A020119009.nex';'A020119010.nex';'A020119011.nex';'A020119012.nex';'A020119013.nex'};
RWmultiplier19 = [0.8;0.8;0.8;0.8;1.0;0.7;0.8;0.8;0.7;0.8;0.7];
filename20 = {'A020319001.nex';'A020319002.nex';'A020319003.nex';'A020319006.nex';'A020319007.nex';'A020319008.nex';'A020319009.nex'};
RWmultiplier20 = [0.8;0.8;0.8;0.8;0.8;0.8;0.8;0.8];
filename = [filename14;filename15;filename16;filename17;filename18;filename19;filename20];
RWmultiplier = [RWmultiplier14; RWmultiplier15; RWmultiplier16; RWmultiplier17; RWmultiplier18; RWmultiplier19; RWmultiplier20];
...
LMScontrastallfiles = [];
contrastlattice = linspace(0,1.5,51);
...
grid on; set(gca,'Xlim',[-150 150],'Ylim',[-150 150]); axis square; xlabel('X'); ylabel('Y'); title('RF locations');
