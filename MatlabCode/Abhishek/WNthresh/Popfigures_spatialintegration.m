...
% An extension of the previous code-extending for colored images instead of grayscale images 
...
%% Determining the spatial interaction between the subunits using WN projection analysis- an analysis that could motivate why isoresponse is needed in the first place 
...
% Plotting the results for SVD based cone weight classification including the PC1 z-scores 
figure(plot_counter);
subplot(221); histogram(100*(Acrosssubunits_medianofdifferences(LUMidx)),linspace(-2,8,21),'FaceColor',[0 0 0],'EdgeColor',[1 1 1]); hold on;
plot(median(100*(Acrosssubunits_medianofdifferences(LUMidx))),15,'v','MarkerSize',8,'MarkerFaceColor',[0 0 0],'MarkerEdgeColor',[1 1 1]);
plot(100*(Acrosssubunits_medianofdifferences(indices(1))),18,'s','MarkerSize',8,'MarkerFaceColor',[0 1 0],'MarkerEdgeColor',[1 1 1]);
set(gca,'Tickdir','out','Xlim',[-2 8],'Ylim',[0 20],'YTick',[0 10 20]); xlabel('median CV GQM-GLM AUROC'); ylabel('Count'); title('Across subunits'); axis square; hold off;
subplot(222); histogram(100*(Acrosssubunits_medianofdifferences(DOidx)),linspace(-2,8,21),'FaceColor',[1 0 0],'EdgeColor',[1 1 1]); hold on;
plot(median(100*(Acrosssubunits_medianofdifferences(DOidx))),15,'v','MarkerSize',8,'MarkerFaceColor',[1 0 0],'MarkerEdgeColor',[1 1 1]);
plot(100*(Acrosssubunits_medianofdifferences(indices(2))),18,'s','MarkerSize',8,'MarkerFaceColor',[0 1 0],'MarkerEdgeColor',[1 1 1]);
set(gca,'Tickdir','out','Xlim',[-2 8],'Ylim',[0 20],'YTick',[0 5 10 20]); xlabel('median CV GQM-GLM AUROC'); ylabel('Count'); title('Across subunits'); axis square; hold off;
subplot(223); histogram(100*(Acrosssubunits_medianofdifferences(hardtoclassifyidx)),linspace(-2,8,21),'FaceColor',[0.5 0.5 0.5],'EdgeColor',[1 1 1]); hold on;
plot(median(100*(Acrosssubunits_medianofdifferences(hardtoclassifyidx))),20,'v','MarkerSize',8,'MarkerFaceColor',[0.5 0.5 0.5],'MarkerEdgeColor',[1 1 1]);
plot(100*(Acrosssubunits_medianofdifferences(indices(3))),23,'s','MarkerSize',8,'MarkerFaceColor',[0 1 0],'MarkerEdgeColor',[1 1 1]);
set(gca,'Tickdir','out','Xlim',[-2 8],'Ylim',[0 25],'YTick',[0 5 10 15 20 25]); xlabel('median CV GQM-GLM AUROC'); ylabel('Count'); title('Across subunits'); axis square; hold off;
subplot(224), plot(log10(RSSEisoresp_medianofratios(LUMidx)),100*(Acrosssubunits_medianofdifferences(LUMidx)),'o','MarkerFaceColor',[0 0 0],'MarkerEdgeColor',[1 1 1]); hold on; 
plot(log10(RSSEisoresp_medianofratios(DOidx)),100*(Acrosssubunits_medianofdifferences(DOidx)),'o','MarkerFaceColor',[1 0 0],'MarkerEdgeColor',[1 1 1]); hold on; 
plot(log10(RSSEisoresp_medianofratios(hardtoclassifyidx)),100*(Acrosssubunits_medianofdifferences(hardtoclassifyidx)),'o','MarkerFaceColor',[0.5 0.5 0.5],'MarkerEdgeColor',[1 1 1]); hold on; 
axis square; set(gca,'Tickdir','out','Xlim',[-1 3],'XTick',[-1 0 1 2 3],'Ylim',[-2 8],'YTick',-2:2:8); xlabel('Spatial NLI isoresponse'); ylabel('median CV GQM-GLM AUROC');
plot_counter = plot_counter + 1;

% Comparing spatial NLI across cell types
group = [ones(size(LUMidx)) 2*ones(size(DOidx)) 3*ones(size(hardtoclassifyidx))];
data = Acrosssubunits_medianofdifferences([LUMidx'; DOidx'; hardtoclassifyidx']); 
p1 = kruskalwallis(data,group);

[r,p2] = corr(log10(RSSEisoresp_medianofratios),100*(Acrosssubunits_medianofdifferences),'type','Spearman');
