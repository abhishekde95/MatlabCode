...
%% Code for plotting the checkerboard STA along with the spatial weighting map
...
%% Figure 4: Impact of S-cone input on signal integration: Isoresponse data 
