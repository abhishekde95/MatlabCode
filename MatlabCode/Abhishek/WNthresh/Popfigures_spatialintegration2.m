...
%% A control analysis: Some more analyses that Greg suggested
...
%% Figure S4 (No longer using this part)
...
%% Figure S5- Population analysis of isoresponse curves: linear error vs. non-linear error 
if ~exist('plot_counter')
    plot_counter = 1;
end
