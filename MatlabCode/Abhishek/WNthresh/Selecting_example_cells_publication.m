...
% Load the integration across subunits
...
for ii = 1:numel(filename)
    ...
    elseif ismember(ii,hardtoclassifyidx)
        ...
        set(gca,'XLim',[-2 2],'YLim',[-2 2]); drawnow; axis square; title(strcat(num2str(RSSEisoresp_medianofratios(ii),2),',',num2str(100*Acrosssubunits_medianofdifferences(ii),2))); grid on; hold off; drawnow;
