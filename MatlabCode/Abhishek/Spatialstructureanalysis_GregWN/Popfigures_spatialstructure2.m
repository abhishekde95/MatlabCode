% A replica of Popfigures_spatialstructure with minor corrections. These
% data were *not* submitted to the JoV first submission
...
%% Addtional figure 1: Analysis of spatial opponency - paramteric method using Gabor fits 
if ~exist('plot_counter')
    plot_counter = 1;
end
% load Output_ListWN.mat
...
%% Additional figure 2: Control Plot of cone weights of all the screened cells
% Calculating conewts of the cells of interest: SVD 
if ~exist('plot_counter')
    plot_counter = 1;
end
...
%% Additional figure 3: Model comparison, Gabor vs DOG, Gabor phases, aspect ratios, non-concentric DoG vs. Gabor  
if ~exist('plot_counter')
    plot_counter = 1;
end
...
%% Additional figure 4: Model comparison of DOG vs Gabor (CV per accuracy, mean SSE & BIC
...
%% Additional figure 5: Model comparison of Crescent vs Gabor (CV per accuracy, mean SSE & BIC)
