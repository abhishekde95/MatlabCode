function [C, trialParamsHeader, exptParamsHeader, additionalRasterFields, badLogic, otherInstructions] = GridLMSubunitCodes()
...
trialParamsHeader = {
    ...
    'DVAPerStix',       'float', 0, C.DVAPERSTIXCD
    'StimDur',          'float', 0, C.STIMDURCD
    'NFrames',          'int', 0, C.NFRAMESCD
    'Epoch',            'int', 0, C.EPOCHCD
    'Seed',             'long', 0, C.SEEDCD
    }';
