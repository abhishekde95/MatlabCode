...
if ismac
    save('/Users/jpatrickweller/Dropbox/VisionResearchPaper/Fig2cData(NLtransRS)','data');
else ispc
    save('C:\Users\jpweller\Dropbox\VisionResearchPaper\Fig2cData(NLtransRS)','data');
end

% Say goodbye
disp('Fig 2c Modeling Completed.')
