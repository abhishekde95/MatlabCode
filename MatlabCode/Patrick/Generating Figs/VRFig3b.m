...
if ismac
    save('/Users/jpatrickweller/Dropbox/VisionResearchPaper/Fig3bData(transRS)3','data');
else ispc
    save('C:\Users\jpweller\Dropbox\VisionResearchPaper\Fig3bData(transRS)3','data');
end

% Say goodbye
disp('Data saved to Dropbox.')
disp('Fig 3b Modeling Completed.')
