...
%
% Uses mexPlexDO.dll and PlexDO.dll.  NI drivers (NIDAQ 6.9 or above) must 
% be installed.
%
%
...
pulseLine = 2; % use line 2 (GPCTR1) as strobe bit
...
for i = 0:255
  ...
  PL_DOSetWord(deviceNumbers(1), 1, 8, i); % bits 1 through 8 (low 8 bits of i are used)
